...
export const initialCards = [
  ...
  export const profileDescription = document.querySelector(".js-profile-description");
  ...
  export const profileEditModal = document.querySelector(".js-profile-edit-modal");
